...
export const FilterEvents = ({ activeFilter, setActiveFilter }) => {
  const filterButtons = [
      ...
      <div className="flex gap-4 mb-5 justify-center flex-wrap">
        {filterButtons.map((button) => (
          <button
            ...
            className={`px-6 py-3 rounded-lg font-semibold text-lg transition-all duration-300 ${activeFilter === button.id
